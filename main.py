...
def main():
    ...
    impath_label_x = get_pacs_image_dirs(root=config['data']['root'],
                                         dname=config['data']['source_domain_x'],
                                         split="train")  #源域1
    impath_label_u_1 = get_pacs_image_dirs(root=config['data']['root'],
                                           dname=config['data']['source_domain_u_1'],
                                           split="train")  #源域2
    impath_label_u_2 = get_pacs_image_dirs(root=config['data']['root'],
                                           dname=config['data']['source_domain_u_2'],
                                           split="train")  #源域3
    impath_label_t = get_pacs_image_dirs(root=config['data']['root'],
