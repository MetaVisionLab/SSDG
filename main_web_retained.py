...
def main():
    ...
    config['trainer']['save_model_addr'] = f"{config['trainer']['save_model_addr']}_retained"
    config['log']['save_name'] = f"{config['log']['save_name']}_retained"
    ...
    train_data = impath_label_x + impath_label_u_1  #数据为路径加标签，即文本中的一行
